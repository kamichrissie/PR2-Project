...
class EllipseCoordinates{
  ...
  //Ellipsen Typ erstellen
public:
  EllipseCoordinates(double px, double py, double palpha, double pr1, double pr2);
...
public:
  ...
  //Ellipsen übergeben
  std::vector<EllipseCoordinates> ellipses_pass(const std::vector<Line> &lines);
